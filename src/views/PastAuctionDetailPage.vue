    ...
    <div class="container mx-auto px-5 nunito-sans-light">
      <div class="text-sm text-[#7A7A7A] my-8">
        <nav aria-label="Breadcrumb">
          <ol class="list-reset flex">
            ...
            <li><router-link to="/past-auction" class="text-[#B8B8B8]">live Auction</router-link><span class="mx-2 text-[#B8B8B8]">></span></li>
      ...
      <div v-if="product" class="flex flex-col md:flex-row gap-10">
        ...
        <div class="w-full md:w-1/2">
          <img :src="`https://wickmans.basedev.co.uk${product.image}`" alt="Product Image" class="w-full object-cover border border-grey" />
        ...
        <div class="w-full md:w-1/3 space-y-4">
          ...
          <div class="flex justify-between">
            <div class="flex flex-col border  py-3  w-full text-center ">
              ...
              <span class="text-gray-800 font-semibold nunito-sans-light text-[20px]">${{ product.reserve_price }}</span>
            </div>
            <div class="flex flex-col py-3 border-b border-t border-r w-full text-center bg-[#f3e9ea]">
              ...
              <span class="text-[#8a2432] font-semibold text-[20px] nunito-sans-light">${{ product.buy_now_price }}</span>
            </div>
          </div>
...
export default {
  ...
  methods: {
    async fetchProductDetails() {
      const { id } = this;  // Access 'id' prop directly
      const url = `https://wickmans.basedev.co.uk/api/lots/detail/${id}`;
